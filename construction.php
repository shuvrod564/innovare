...
<body class="pt-0"> 
    ...
    <section class="py-5 bg-primary">
        <div class="container py-xl-4">
            <div class="row g-4 g-xxl-5">
                ...
                <div class="col-lg-6">
                    <div class="py-lg-2 text-white text-center text-lg-start"> 
                        <p class="top__title text-white fw-semibold lead-lg">A Legacy of Quality and Trust</p>
                        <p class=" mt-3">
                            Innovare Constructions, a distinguished construction company in Kottayam, is celebrated for its decades of experience and unwavering commitment to quality. Our journey is adorned with numerous awards and recognitions, underscoring our position as leaders in the construction industry. Testimonials from our satisfied clients reflect the deep trust and strong local presence we've established in Kottayam and beyond. Choose Innovare for a partnership where excellence is built into every project, ensuring your vision is realized with precision and care.
                        </p>
                    </div>
                </div><!--//.col-->
            </div><!--//.row-->
    ...
    <section class="py-md-5 pb-5">
        <div class="container">
            <div class="row g-4 g-xxl-5">
                <div class="col-lg-5">
                    <img 
                        src="assets/images/construction/construction-concept.webp" 
                        width="512" height="482" 
                        alt="Innovare Constructions"
                        class="img-fluid w-100 object-fit-cover" 
                    >
                </div><!--//.col-->
    ...
    <!--Innovare Customized section End -->
            ...
            <div class="carousel__wrapper">
                <div class="owl-carousel serviceSlider">
                    <div class="services__card bg-primary text-white">
                        ...
                        <p class="mt-3">Your dream begins with a conversation. As the premier construction company in Kottayam, we listen to your visions and requirements, setting the foundation for a project that truly reflects your individuality.</p>  
                    </div> 
                    <div class="services__card bg-primary text-white">
                        ...
                        <p class="mt-3">Our experts craft bespoke designs, blending your ideas with our innovative solutions, whether it's for residential construction in Kottayam or commercial construction in Kottayam.</p> 
                    </div>
                    <div class="services__card bg-primary text-white">
                        ...
                        <p class="mt-3">Visualize your future space with detailed 3D renderings, allowing for adjustments before the build begins.</p> 
                    </div>
                    <div class="services__card bg-primary text-white">
                        ...
                        <p class="mt-3">We guide you through selecting high-quality, sustainable materials that align with your vision and our green building practices.</p> 
                    </div>
                    <div class="services__card bg-primary text-white">
                        ...
                        <p class="mt-3">Our skilled team brings the plan to life, ensuring every detail embodies excellence, from foundation to finish.</p> 
                    </div>
    ...
    <section class="py-5">
        <div class="container py-xl-5">
            <div class="row g-4 g-xxl-5">
                <div class="col-lg-5 order-lg-2">
                    <img 
                        src="assets/images/construction/silhouette-group.webp" 
                        width="512" height="379" 
                        alt="Innovare Constructions"
                        class="img-fluid w-100 object-fit-cover" 
                    >
